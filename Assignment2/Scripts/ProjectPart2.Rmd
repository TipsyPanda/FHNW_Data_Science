...
preprocRecipe <-
 ...
 step_smote(status, over_ratio = 0.25, skip=TRUE) %>%
...
pred <- model %>% 
         predict(test_data)
pred <- apply(pred, MARGIN = 2, which.max)
dim(keras_predict(mod, test_data))
...
# write.csv(average_acc_history, "../Doc/Versuch 9 - 8 Layer - 1 256 - Smote/Try 9.csv", row.names=FALSE)
# save_model_hdf5(model, "../Doc/Versuch 9 - 8 Layer - 1 256 - Smote/model 9.hfd5", overwrite = TRUE, include_optimizer = TRUE)

# Save Training, Testing and Validation Data
# write.csv(train_data, "../Doc/Versuch 9 - 8 Layer - 1 256 - Smote/train_data.csv", row.names=FALSE)
# write.csv(test_data, "../Doc/Versuch 9 - 8 Layer - 1 256 - Smote/test_data.csv", row.names=FALSE)
# write.csv(train_targets, "../Doc/Versuch 9 - 8 Layer - 1 256 - Smote/train_targets.csv", row.names=FALSE)
# write.csv(test_targets, "../Doc/Versuch 9 - 8 Layer - 1 256 - Smote/test_targets.csv", row.names=FALSE)
