...
# write.csv(average_acc_history, "../Doc/Versuch 7 - 6 Layer Smote/Try 7.csv", row.names=FALSE)
# save_model_hdf5(model, "../Doc/Versuch 7 - 6 Layer Smote/model 7.hfd5", overwrite = TRUE, include_optimizer = TRUE)
