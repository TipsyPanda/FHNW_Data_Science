...
#LOAD DATA
setwd(getwd())
dataIn = "./Data/In/Project/Dataset-part-2.csv"
dataOut = "./Data/Out/Project/Dataset-part-2.csv"
# does no twork for some reason: data_in <- read.csv(dataIn,header = TRUE, sep =',') 
 data_in <- read.csv("C:/Users/yanni/Documents/FHNW_Data_Science/Data/In/Project/Dataset-part-2.csv",header = TRUE, sep =',') 
View(data_in)
