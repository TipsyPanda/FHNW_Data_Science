<<<<<<< Updated upstream:Scripts/DataCleaning/Old/Data Cleaning LCdata final version.Rmd
<<<<<<< Updated upstream
---
...
=======
=======
>>>>>>> Stashed changes:Scripts/DataCleaning/Data Cleaning LCdata final version.Rmd
---
title: "Data Cleaning LCdata"
output:
  pdf_document: default
...
Finally, we use the "as.factor" function to convert the "year_group" column to a factor variable.
...
#Delete column zip code
"The "character" column contains an excessive number of unique values, making it difficult to accurately categorize the data. As a result, it is advisable to remove this column from the dataset to avoid introducing unnecessary complexity into the analysis."
...
ggplot(data = cleaning, mapping = aes(x=int_rate,y=term))+geom_boxplot()
ggplot(data = cleaning, mapping = aes(x=int_rate,y=home_ownership))+geom_boxplot()
ggplot(data = cleaning, mapping = aes(x=int_rate,y=purpose))+geom_boxplot()
ggplot(data = cleaning, mapping = aes(x=int_rate,y=verification_status))+geom_boxplot()
ggplot(data = cleaning, mapping = aes(x=int_rate,y=mths_since_delinq_cat))+geom_boxplot()
ggplot(data = cleaning, mapping = aes(x=int_rate,y=mths_since_last_record_cat))+geom_boxplot()
ggplot(data = cleaning, mapping = aes(x=int_rate,y=mths_since_last_major_derog_cat))+geom_boxplot()
ggplot(data = cleaning, mapping = aes(x=int_rate,y=annual_inc_merged))+geom_boxplot()
ggplot(data = cleaning, mapping = aes(x=int_rate,y=dti_merged))+geom_boxplot()
ggplot(data = cleaning, mapping = aes(x=int_rate,y=year_group))+geom_boxplot()
ggplot(data = cleaning, mapping = aes(x=int_rate,y=region))+geom_boxplot()
...
ggplot(data=cleaning, aes(x=int_rate, y=loan_amnt)) +
  geom_point()
ggplot(data=cleaning, aes(x=int_rate, y=loan_amnt)) +
  geom_point() +
  geom_smooth(method=lm)

ggplot(data=cleaning, aes(x=int_rate, y=installment)) +
  geom_point()
ggplot(data=cleaning, aes(x=int_rate, y=installment)) +
  geom_point() +
  geom_smooth(method=lm)

ggplot(data=cleaning, aes(x=int_rate, y=delinq_2yrs)) +
  geom_point()
ggplot(data=cleaning, aes(x=int_rate, y=delinq_2yrs)) +
  geom_point() +
  geom_smooth(method=lm)

ggplot(data=cleaning, aes(x=int_rate, y=inq_last_6mths)) +
  geom_point()
ggplot(data=cleaning, aes(x=int_rate, y=inq_last_6mths)) +
  geom_point() +
  geom_smooth(method=lm)

ggplot(data=cleaning, aes(x=int_rate, y=open_acc)) +
  geom_point()
ggplot(data=cleaning, aes(x=int_rate, y=open_acc)) +
  geom_point() +
  geom_smooth(method=lm)
...
ggplot(data=cleaning, aes(x=int_rate, y=pub_rec)) +
  geom_point()
ggplot(data=cleaning, aes(x=int_rate, y=pub_rec)) +
  geom_point() +
  geom_smooth(method=lm)
...
ggplot(data=cleaning, aes(x=int_rate, y=revol_bal)) +
  geom_point()
ggplot(data=cleaning, aes(x=int_rate, y=revol_bal)) +
  geom_point() +
  geom_smooth(method=lm)

ggplot(data=cleaning, aes(x=int_rate, y=revol_util)) +
  geom_point()
ggplot(data=cleaning, aes(x=int_rate, y=revol_util)) +
  geom_point() +
  geom_smooth(method=lm)

ggplot(data=cleaning, aes(x=int_rate, y=total_acc)) +
  geom_point()
ggplot(data=cleaning, aes(x=int_rate, y=total_acc)) +
  geom_point() +
  geom_smooth(method=lm)

ggplot(data=cleaning, aes(x=int_rate, y=initial_list_status)) +
  geom_point()
ggplot(data=cleaning, aes(x=int_rate, y=initial_list_status)) +
  geom_point() +
  geom_smooth(method=lm)

ggplot(data=cleaning, aes(x=int_rate, y=out_prncp)) +
  geom_point()
ggplot(data=cleaning, aes(x=int_rate, y=out_prncp)) +
  geom_point() +
  geom_smooth(method=lm)

ggplot(data=cleaning, aes(x=int_rate, y=out_prncp_inv)) +
  geom_point()
ggplot(data=cleaning, aes(x=int_rate, y=out_prncp_inv)) +
  geom_point() +
  geom_smooth(method=lm)

ggplot(data=cleaning, aes(x=int_rate, y=collections_12_mths_ex_med)) +
  geom_point()
ggplot(data=cleaning, aes(x=int_rate, y=collections_12_mths_ex_med)) +
  geom_point() +
  geom_smooth(method=lm)

ggplot(data=cleaning, aes(x=int_rate, y=acc_now_delinq)) +
  geom_point()
ggplot(data=cleaning, aes(x=int_rate, y=acc_now_delinq)) +
  geom_point() +
  geom_smooth(method=lm)

ggplot(data=cleaning, aes(x=int_rate, y=tot_coll_amt)) +
  geom_point()
ggplot(data=cleaning, aes(x=int_rate, y=tot_coll_amt)) +
  geom_point() +
  geom_smooth(method=lm)

ggplot(data=cleaning, aes(x=int_rate, y=tot_cur_bal)) +
  geom_point()
ggplot(data=cleaning, aes(x=int_rate, y=tot_cur_bal)) +
  geom_point() +
  geom_smooth(method=lm)

ggplot(data=cleaning, aes(x=int_rate, y=open_acc_6m)) +
  geom_point()
ggplot(data=cleaning, aes(x=int_rate, y=open_acc_6m)) +
  geom_point() +
  geom_smooth(method=lm)

ggplot(data=cleaning, aes(x=int_rate, y=open_il_6m)) +
  geom_point()
ggplot(data=cleaning, aes(x=int_rate, y=open_il_6m)) +
  geom_point() +
  geom_smooth(method=lm)

ggplot(data=cleaning, aes(x=int_rate, y=open_il_12m)) +
  geom_point()
ggplot(data=cleaning, aes(x=int_rate, y=open_il_12m)) +
  geom_point() +
  geom_smooth(method=lm)

ggplot(data=cleaning, aes(x=int_rate, y=open_il_24m)) +
  geom_point()
ggplot(data=cleaning, aes(x=int_rate, y=open_il_24m)) +
  geom_point() +
  geom_smooth(method=lm)

ggplot(data=cleaning, aes(x=int_rate, y=mths_since_rcnt_il)) +
  geom_point()
ggplot(data=cleaning, aes(x=int_rate, y=mths_since_rcnt_il)) +
  geom_point() +
  geom_smooth(method=lm)

ggplot(data=cleaning, aes(x=int_rate, y=total_bal_il)) +
  geom_point()
ggplot(data=cleaning, aes(x=int_rate, y=total_bal_il)) +
  geom_point() +
  geom_smooth(method=lm)

ggplot(data=cleaning, aes(x=int_rate, y=il_util)) +
  geom_point()
ggplot(data=cleaning, aes(x=int_rate, y=il_util)) +
  geom_point() +
  geom_smooth(method=lm)

ggplot(data=cleaning, aes(x=int_rate, y=open_rv_12m)) +
  geom_point()
ggplot(data=cleaning, aes(x=int_rate, y=open_rv_12m)) +
  geom_point() +
  geom_smooth(method=lm)

ggplot(data=cleaning, aes(x=int_rate, y=open_rv_24m)) +
  geom_point()
ggplot(data=cleaning, aes(x=int_rate, y=open_rv_24m)) +
  geom_point() +
  geom_smooth(method=lm)

ggplot(data=cleaning, aes(x=int_rate, y=max_bal_bc)) +
  geom_point()
ggplot(data=cleaning, aes(x=int_rate, y=max_bal_bc)) +
  geom_point() +
  geom_smooth(method=lm)

ggplot(data=cleaning, aes(x=int_rate, y=all_util)) +
  geom_point()
ggplot(data=cleaning, aes(x=int_rate, y=all_util)) +
  geom_point() +
  geom_smooth(method=lm)

ggplot(data=cleaning, aes(x=int_rate, y=total_rev_hi_lim)) +
  geom_point()
ggplot(data=cleaning, aes(x=int_rate, y=total_rev_hi_lim)) +
  geom_point() +
  geom_smooth(method=lm)

ggplot(data=cleaning, aes(x=int_rate, y=inq_fi)) +
  geom_point()
ggplot(data=cleaning, aes(x=int_rate, y=inq_fi)) +
  geom_point() +
  geom_smooth(method=lm)

ggplot(data=cleaning, aes(x=int_rate, y=total_cu_tl)) +
  geom_point()
ggplot(data=cleaning, aes(x=int_rate, y=total_cu_tl)) +
  geom_point() +
  geom_smooth(method=lm)

ggplot(data=cleaning, aes(x=int_rate, y=inq_last_12m)) +
  geom_point()
ggplot(data=cleaning, aes(x=int_rate, y=inq_last_12m)) +
  geom_point() +
  geom_smooth(method=lm)
