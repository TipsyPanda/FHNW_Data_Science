...
getwd()
xgb_res <- readRDS("./DataCleaning/Cleandata.rds")
lcdata <- data.frame(lcdata %>% dplyr::select(int_rate, term, loan_amnt,dti,annual_inc,emp_length,funded_amnt ,funded_amnt_inv,term ,installment,home_ownership,purpose))
...
set.seed(713)
trainIndex <- initial_split(lcdata, prop = 0.8, strata = int_rate) #stratify the class attribute since it is right skewed.This bins the data into quartiles
