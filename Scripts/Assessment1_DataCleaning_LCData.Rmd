...
In data cleaning, it is often necessary
...
During the data cleaning process, we observed that the "home_ownership" variable
does not appear to exhibit a clear correlation with interest rates. Specifically, the categories
...
"The"character" column contains an excessive
...
Last but not least just deleting 
...
Checking if other in purpose is really just other
