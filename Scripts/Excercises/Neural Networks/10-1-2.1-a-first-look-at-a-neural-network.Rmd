...
Now load the mnist data set. If you experience a problem with accessing the dataset then download it from https://storage.googleapis.com/tensorflow/tf-keras-datasets/mnist.npz and then specify the path where you stored it

```{r}
mnist <- dataset_mnist()
#mnist <- dataset_mnist(path="/Users/holger.wache/Desktop/mnist.npz")
```

Extract the images with their labels for training and test.
