...
cols <- c("emp_length", "home_ownership", "purpose")
...
xgb_grid <- grid_latin_hypercube(
  ...
  learn_rate(),
  size = 15 #can be set to a higher value to improve results but is very time consuming
)
...
```{r setup vfold}
set.seed(123)
vb_folds <- vfold_cv(trainingSet, v = 2, strata = int_rate) 
```
