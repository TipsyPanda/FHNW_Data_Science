...
The final model has now been fit to the training and test data sets. The spplit rate was adjusted to 95% training data in order to get the best fit possible. 

```{r final fit}
set.seed(33)
trainIndex2 <- initial_split(lcdata, prop = 0.95, strata = int_rate)
